...
const skillGroups = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Firestore DB", level: "Intermediate" },
      { name: "Realtime DB", level: "Intermediate" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Artifactory", level: "Advanced" },
      { name: "LogRocket", level: "Advanced" },
      { name: "LogExplorer", level: "Advanced" },
      { name: "Fault Tolerance", level: "Advanced" },
      { name: "Metrics Tracking", level: "Advanced" },
    ],
  },
];
  ...
  return (
    <>
      ...
      >
        ...
        {/* 🔽 Picture/Icon Skills Section SECOND */}
